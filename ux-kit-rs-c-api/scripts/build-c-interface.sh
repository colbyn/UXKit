...
# CRATE NAME
#―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
CRATE_AR_ARCHIVE_NAME_SRC="libnotebook_engine_c_api.a"
CRATE_AR_ARCHIVE_NAME_DEST_IOS="libnotebook_engine_c_api.a"
CRATE_AR_ARCHIVE_NAME_DEST_MACOS="libnotebook_engine_c_api.a"
CRATE_AR_ARCHIVE_NAME_DEST_CATALYST="libnotebook_engine_c_api.a"
...
SWIFT_INCLUDE_HEADER_FILE_PATH="$SWIFT_C_INCLUDE_DIR/notebook-engine.h"
