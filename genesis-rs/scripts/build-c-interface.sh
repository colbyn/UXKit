...
# CRATE NAME
#―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
CRATE_AR_ARCHIVE_NAME_SRC="libgenesis_rs.a"
CRATE_AR_ARCHIVE_NAME_DEST_IOS="libgenesis_rs.a"
CRATE_AR_ARCHIVE_NAME_DEST_MACOS="libgenesis_rs.a"
CRATE_AR_ARCHIVE_NAME_DEST_CATALYST="libgenesis_rs.a"
...
SWIFT_INCLUDE_HEADER_FILE_PATH="$SWIFT_C_INCLUDE_DIR/genesis-rs.h"
